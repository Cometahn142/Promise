...
After that, install dependencies through your normal Wally workflow and expose the package through your Rojo project as you would with any other shared module.

## Method 2: Manual

If you are not using a package manager yet, you can still use the library directly:
...
If your project vendors libraries directly into source control, place Promise in your third-party module folder and sync it through Rojo. This approach is often useful when you want full control over version bumps and reviewable diffs.
